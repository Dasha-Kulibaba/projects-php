...
<head>
	...
	<title>Віртуальний кабінет МФК СумДУ - Молодому викладачу</title>
</head>
	...
	<main>
		<section class="catalog" aria-labelledby="catalogTitle">
			<div class="catalog__container">
				<aside
					class="catalog__container-sidebar"
					aria-label="Фільтри матеріалів">
					<div class="catalog__container-sidebar-filter">
						...
						<label class="checkbox">
							<input
								...
								value="3"
								class="checkbox__input"
								aria-label="Методичні рекомендації" />
							<span class="checkbox__box"></span>
				...
				<div class="catalog__container-content">
					<h2 id="catalogTitle" class="visually-hidden">
						Каталог матеріалів
					</h2>
	...
	<dialog
		...
		<div class="mobile-overlay__body">
			<ul class="mobile-overlay__list">
				...
				<li class="mobile-overlay__item">
					<a class="mobile-overlay__link active-pointer" href="new.php">Молодому викладачу</a>
				</li>
				<li class="mobile-overlay__item">
