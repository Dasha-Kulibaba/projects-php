...
<head>
	...
	<title>Віртуальний кабінет МФК СумДУ - Підвищення кваліфікації</title>
</head>
...
<body>
	...
	<main>
		<section class="qual" aria-labelledby="plan-title">
			<div class="qual__container">
				<div class="news__container-title">
					<h2 class="news__container-title-h2" id="plan-title">
						Плани підвищення кваліфікації
					</h2>
				</div>
				<div class="catalog__container-content">
					<div class="catalog__container-content-list" id="content"></div>
				</div>
			</div>
		</section>

		<section class="qual" aria-labelledby="courses-title">
			<div class="qual__container">
				<div class="news__container-title">
					<h2 class="news__container-title-h2" id="courses-title">
						Актуальні курси
					</h2>
				</div>
				<div class="qual__container-list" id="course"></div>
			</div>
		</section>
	</main>
	...
	<dialog
		...
		<div class="mobile-overlay__body">
			<ul class="mobile-overlay__list">
				...
				<li class="mobile-overlay__item">
					<a class="mobile-overlay__link active-pointer" href="qual.php">Підвищення кваліфікації</a>
				</li>
				<li class="mobile-overlay__item">
